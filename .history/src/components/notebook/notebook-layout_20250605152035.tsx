              ...
              <div key={source.id} className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <MdFileText className="w-4 h-4 text-red-500 flex-shrink-0" />
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center max-w-md">
                  <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <MdMessage className="w-8 h-8 text-orange-500" />
                  </div>
          ...
          <div className="space-y-3">
            <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
              <div className="flex items-center gap-2 mb-2">
                <MdMic className="w-4 h-4 text-orange-600" />
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Button variant="ghost" size="sm" className="w-full justify-start text-left">
                <MdBook className="w-4 h-4 mr-2" />
                Study guide
              </Button>
              <Button variant="ghost" size="sm" className="w-full justify-start text-left">
                <MdFileText className="w-4 h-4 mr-2" />
                FAQ
              </Button>
              <Button variant="ghost" size="sm" className="w-full justify-start text-left">
                <MdTimeline className="w-4 h-4 mr-2" />
                Timeline
              </Button>
              <Button variant="ghost" size="sm" className="w-full justify-start text-left">
