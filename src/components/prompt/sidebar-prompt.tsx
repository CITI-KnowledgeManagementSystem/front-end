...
const SidebarPrompt = () => {
    ...
    return (
        <aside className={`h-screen`}>
            <nav className={`h-full ${isOpen ? 'w-72 p-4' : 'w-0 py-5'} flex flex-col bg-slate-200 border-r shadow-sm relative duration-300 ease-in-out`}>
                {!isOpen && <HoverCard>
                ...
                {isOpen ?
                    <HoverCard>
                        <HoverCardTrigger asChild className='w-fit absolute -right-10 top-1/2 z-40'>
